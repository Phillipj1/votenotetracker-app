import 'dotenv/config'; // loads your .env file so process.env.ANTHROPIC_API_KEY works
...
async function startDevelopmentServer() {
  ...
  // Note: summarization is now handled directly in the browser via Puter.js
  // (see App.tsx) — no backend route or API key needed for it anymore.
